...
class PclRequest extends RestRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'international_college_name' => ((isset($this->college_type) && $this->college_type == 'nepal' && isset($this->board_university) && $this->board_university == 'CTEVT, NEPAL') || ($this->id > 0)) ? 'sometimes' : 'required',
