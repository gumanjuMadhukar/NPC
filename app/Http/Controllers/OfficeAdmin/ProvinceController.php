...
use App\Http\Requests\OfficeAdmin\Province\StoreRequest;
use App\Models\Province;
use App\Services\OfficeAdmin\ProvinceService;
...
class ProvinceController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.province.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('office_admin-province-store');
        $data['row'] = Province::where('id', $id)->first();
        return view('officeadmin.province.add', $data);
    }
