...
use App\Http\Requests\OfficeAdmin\Level\StoreRequest;
use App\Models\Level;
use App\Services\OfficeAdmin\LevelService;
...
class LevelController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.level.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('office_admin-level-store');
        $data['order'] = getMax('levels', 'order');
        $data['row'] = Level::where('id', $id)->first();
        return view('officeadmin.level.add', $data);
    }
