...
use App\Http\Requests\OfficeAdmin\College\StoreRequest;
use App\Models\College;
use App\Services\OfficeAdmin\CollegeService;
...
class CollegeController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.college.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('office_admin-college-store');
        $data['row'] = College::where('id', $id)->first();
        return view('officeadmin.college.add', $data);
    }
