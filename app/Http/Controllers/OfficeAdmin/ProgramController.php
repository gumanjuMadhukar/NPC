...
use App\Http\Requests\OfficeAdmin\Program\StoreRequest;
use App\Models\Level;
use App\Models\Program;
use App\Models\SubjectCommittee;
use App\Services\OfficeAdmin\ProgramService;
...
class ProgramController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.program.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('office_admin-program-store');
        ...
        return view('officeadmin.program.add', $data);
    }
