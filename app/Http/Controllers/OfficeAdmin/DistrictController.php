...
use App\Http\Requests\OfficeAdmin\District\StoreRequest;
use App\Models\District;
use App\Models\Province;
use App\Services\OfficeAdmin\DistrictService;
...
class DistrictController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.district.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('office_admin-district-store');
        $data['provinces'] = Province::where('status', 1)->get();
        $data['row'] = District::where('id', $id)->first();
        return view('officeadmin.district.add', $data);
    }
