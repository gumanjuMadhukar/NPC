...
use App\Http\Requests\Common\Applicant\ApplyRequest;
use App\Http\Requests\Common\Applicant\BachelorRequest;
use App\Http\Requests\Common\Applicant\exportProgramWise;
use App\Http\Requests\Common\Applicant\ExportRequest;
use App\Http\Requests\Common\Applicant\MasterRequest;
use App\Http\Requests\Common\Applicant\PclRequest;
use App\Http\Requests\Common\Applicant\PersonalRequest;
use App\Http\Requests\Common\Applicant\SlcRequest;
use App\Http\Requests\Common\Applicant\StateSaveRequest;
use App\Http\Requests\Common\Applicant\StatusSaveRequest;
use App\Http\Requests\Common\Applicant\TslcRequest;
...
use App\Services\OfficeAdmin\ApplicantService;
...
class ApplicantController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('officeadmin.applicant.list', $data);
    }
    ...
    public function statusWiseList($exam_id)
    {
        ...
        return view ('officeadmin.dashboard.program_detail');
    }
    public function myList(Request $request)
    {
        ...
        $data['level_id'] = $request->level_id ?? "";
        $data['program_id'] = $request->program_id ?? '';
        $data['state_name'] = $request->state_name ?? 'office_admin';
        ...
        return view('officeadmin.applicant.progress_list', $data);
    }
    ...
    public function approvedList(Request $request)
    {
        ...
        return view('officeadmin.applicant.my_list', $data);
    }
    ...
    public function profile($id)
    {
        ...
        if ($data['user']) {
            return view('officeadmin.applicant.user', $data);
        } else {
            abort(404);
        }
    }
    ...
    public function personalInfo(Request $request)
    {
        ...
        return view('officeadmin.applicant.personal', $data);
    }
    ...
    public function tslc($id)
    {
        ...
        $data['return_url'] = route('office_admin-applicant-profile', $id);

        return view('officeadmin.applicant.tslc', $data);
    }
    ...
    public function slc($id)
    {
        ...
        return view('officeadmin.applicant.slc', $data);
    }
    ...
    public function pcl($id)
    {
        ...
        $data['user_qualification'] = UserQualification::where(['user_id' => $id, 'level_id' => $data['level_id']])->first();
        $data['return_url'] = route('office_admin-applicant-profile', $id);
        return view('officeadmin.applicant.pcl', $data);
    }
    ...
    public function bachelor($id)
    {
        ...
        return view('officeadmin.applicant.bachelor', $data);
    }
    ...
    public function master($id)
    {
        ...
        return view('officeadmin.applicant.master', $data);
    }
    ...
    public function status(Request $request)
    {
        ...
        return view('office_admin.applicant.status', $data);
    }
    ...
    public function applyForm(Request $request)
    {
        ...
        // dd($data['levels']);
        return view('officeadmin.applicant.apply', $data);
    }
    ...
    public function admitCard($exam_apply_id)
    {
        ...
        // dd($data);
        if ($data['exam_apply']) {
            return view('officeadmin.applicant.admit_card', $data);
        } else {
            abort(404);
        }
    }
