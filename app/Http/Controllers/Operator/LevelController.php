...
use App\Http\Requests\Operator\Level\StoreRequest;
use App\Models\Level;
use App\Services\Operator\LevelService;
...
class LevelController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('operator.level.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('operator-level-store');
        $data['order'] = getMax('levels', 'order');
        $data['row'] = Level::where('id', $id)->first();
        return view('operator.level.add', $data);
    }
