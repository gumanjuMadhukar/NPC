...
use App\Http\Requests\Operator\Municipality\StoreRequest;
use App\Models\Municipality;
use App\Models\District;
use App\Services\Operator\MunicipalityService;
...
class MunicipalityController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('operator.municipality.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('operator-municipality-store');
        $data['districts'] = District::where('status', 1)->get();
        $data['row'] = Municipality::where('id', $id)->first();
        return view('operator.municipality.add', $data);
    }
