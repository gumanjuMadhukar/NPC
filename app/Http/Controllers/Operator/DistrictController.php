...
use App\Http\Requests\Operator\District\StoreRequest;
use App\Models\District;
use App\Models\Province;
use App\Services\Operator\DistrictService;
...
class DistrictController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('operator.district.list', $data);
    }
    ...
    public function addEdit(Request $request)
    {
        ...
        $data['action'] = route('operator-district-store');
        $data['provinces'] = Province::where('status', 1)->get();
        $data['row'] = District::where('id', $id)->first();
        return view('operator.district.add', $data);
    }
