...
class AccountService
{
    ...
    {
        try {
            $id = Auth::guard('admit_card_reader')->id();
    ...
    {
        try {
            if (Hash::check($request['old_password'], Auth::guard('admit_card_reader')->user()->password)) {
                User::whereId(Auth::guard('admit_card_reader')->id())->update([
