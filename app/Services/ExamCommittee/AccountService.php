...
class AccountService
{
    ...
    {
        try {
            $id = Auth::guard('exam_committee')->id();
    ...
    {
        try {
            if (Hash::check($request['old_password'], Auth::guard('exam_committee')->user()->password)) {
                User::whereId(Auth::guard('exam_committee')->id())->update([
