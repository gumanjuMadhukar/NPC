    ...
    @section('content')
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form" method="post" action="{{ route('office_admin-applicant-save-master') }}">
                                    @csrf
                                    ...
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                ...
                                                                id="btn_transcript_mas_marksheet_delete">
                                                            ...
                                                            <div class="drag-area drag-area-transcript_mas_marksheet">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->transcript_mas_marksheet)
                                                                        <img src="{{ $user_qualification->full_transcript_mas_marksheet }}"
                                                            ...
                                                            <input type="file" style="display:none"
                                                                id="drag-transcript_mas_marksheet" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                ...
                                                                id="btn_transcript_bac_2_delete">
                                                                <i class="fa fa-times"></i>
                                                            </button>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                ...
                                                                id="btn_transcript_bac_3_delete">
                                                                <i class="fa fa-times"></i>
                                                            </button>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                ...
                                                                id="btn_provisional_image_delete">
                                                                <i class="fa fa-times"></i>
                                                            </button>
                                                        ...
                                                        <div class="drag-container">
                                                            ...
                                                            <div class="drag-area drag-area-intership_image">
                                                                ...
                                                                <input name="intership_image" type="hidden"
                                                                    ...
                                                                    class="file-input" />
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->intership_image)
                                                                        <img src="{{ $user_qualification->full_intership_image }}"
                                                                            id="display_intership_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_intership_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    <div class="col-md-12 col-lg-12">
                                                        <label class="form-label">NHPC Study Permission Letter
                                                            Image</label><br>
                                                        <div class="drag-container">
                                                            <button type="button"
                                                            ...
                                                            <div class="drag-area drag-area-visa_image">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->visa_image)
                                                                        <img src="{{ $user_qualification->full_visa_image }}"
                                                                            id="display_visa_image" class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_visa_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->passport_image)
                                                                        <img src="{{ $user_qualification->full_passport_image }}"
                                                                            ...
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_passport_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
        ...
        @section('footer-scripts')
            @include('officeadmin.applicant.js.master')
        @endsection
