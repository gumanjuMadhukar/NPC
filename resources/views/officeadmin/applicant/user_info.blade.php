            ...
            <div class="card-body">
                <div class="user-profile-box d-flex flex-column align-items-center">
                    ...
                    <div class="image-preview">
                        <a href="{{ $user->info->full_profile_picture }}" data-fancybox="image" title="{{ $user->info->full_name }}"> <img style="height:250px; width:100% ; object-fit:contain;" src="{{ $user->info->full_profile_picture }}"></a>
                    </div>
                ...
                <ul class="nav nav-tabs" id="documentTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link  active" id="details-tab" data-bs-toggle="tab" data-bs-target="#details"
                            type="button" role="tab" aria-controls="details" aria-selected="true">Detail
                            Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="logs-tab" data-bs-toggle="tab" data-bs-target="#logs"
                            type="button" role="tab" aria-controls="logs" aria-selected="true">Exam Review</button>
                    </li>
                    <div class="edit">
                        <a href="{{ route('office_admin-applicant-personal-info', $user->id) }}"
                            class="btn btn-success">Edit Info</a>
                    </div>
                </ul>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width:100%">
                                        <tbody>
                                            ...
                                            @foreach (['officeadmin', 'officer', 'registrar', 'subject_committee', 'exam_committee'] as $state)
                                                @php
