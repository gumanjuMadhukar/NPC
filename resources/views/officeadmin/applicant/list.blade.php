                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="btn-group mb-2">
                                        ...
                                        <a href="{{ route('office_admin-applicant-admitcard',$applicant->id) }}" class="btn btn-success p-0" title="View" data-bs-toggle="tooltip" data-bs-placement="top">Admit Card</i>
                                        </a>
                                        @endif
                                    </td>
                                </tr>
