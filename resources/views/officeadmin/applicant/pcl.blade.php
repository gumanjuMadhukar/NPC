    ...
    @section('content')
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form" method="post" action="{{ route('office_admin-applicant-save-pcl') }}">
                                    @csrf
                                    ...
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            @else
                                                ...
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    ...
                                                    <select class="form-control select2" name="board_university"
                                                        id="board_university">
                                                        <option value="HSEB"
                                                            @if (old('board_university') == 'HSEB') selected @endif>HSEB</option>
                                                        <option value="PCL"
                                                            @if (old('board_university') == 'PCL') selected @endif>PCL</option>
                                                    </select>
                                                    <!--
                                                    HSEB =>input
                                                    PCL =>drop down -->
                                                ...
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    <label class="form-label">College Name</label>
                                                    <div id="college_name" class="d-none"> <select class="form-control select2"
                                                            name="college_name">
                                                            @if ($colleges->count() > 0)
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="drag-area drag-area-transcript_image">
                                                                <div
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        version="1.1" x="0px" y="0px" width="64px"
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->transcript_image)
                                                                        <img src="{{ $user_qualification->full_transcript_image }}"
                                                                            id="display_transcript_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_transcript_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-transcript_image" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-transcript_bac_1">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->transcript_bac_1)
                                                                        <img src="{{ $user_qualification->full_transcript_bac_1 }}"
                                                                            id="display_transcript_bac_1"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_transcript_bac_1"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-transcript_bac_1" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-transcript_bac_2">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->transcript_bac_2)
                                                                        <img src="{{ $user_qualification->full_transcript_bac_2 }}"
                                                                            id="display_transcript_bac_2"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_transcript_bac_2"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-transcript_bac_2" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-transcript_bac_3">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->transcript_bac_3)
                                                                        <img src="{{ $user_qualification->full_transcript_bac_3 }}"
                                                                            id="display_transcript_bac_3"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_transcript_bac_3"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-transcript_bac_3" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-provisional_image">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->provisional_image)
                                                                        <img src="{{ $user_qualification->full_provisional_image }}"
                                                                            id="display_provisional_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_provisional_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-provisional_image" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <div class="drag-container">
                                                            ...
                                                            <div class="drag-area drag-area-character_image">
                                                                ...
                                                                <input name="character_image" type="hidden"
                                                                    id="character_image"
                                                                    value="{{ $user_qualification->character_image ?? old('character_image') }}"
                                                                    class="file-input" />
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->character_image)
                                                                        <img src="{{ $user_qualification->full_character_image }}"
                                                                            id="display_character_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_character_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-character_image" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-equivalence_certificate">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->equivalence_certificate)
                                                                        <img src="{{ $user_qualification->full_equivalence_certificate }}"
                                                ...
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    <div class="col-md-12 col-lg-12">
                                                        <label class="form-label">Clinical / Community Work Image 1
                                                            *</label><br>
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                class="{{ $user_qualification && $user_qualification->ojt_pcl_community_1_image ? 'd-block' : 'd-none' }} img-delete-btn"
                                                                onclick="imageDelete('ojt_pcl_community_1_image')"
                                                                id="btn_ojt_pcl_community_1_image_delete"><i
                                                                    class="fa fa-times"></i></button>
                                                            <div class="drag-area drag-area-ojt_pcl_community_1_image">
                                                                <div
                                                                    class="dropify-message dropify-message-ojt_pcl_community_1_image {{ $user_qualification && $user_qualification->ojt_pcl_community_1_image ? 'd-none' : 'd-block' }}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        version="1.1" x="0px" y="0px" width="64px"
                                                                        height="64px" viewBox="0 0 64 64"
                                                                ...
                                                                <input name="ojt_pcl_community_1_image" type="hidden"
                                                                    id="ojt_pcl_community_1_image"
                                                                    value="{{ $user_qualification->ojt_pcl_community_1_image ?? old('ojt_pcl_community_1_image') }}"
                                                                    class="file-input" />
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->ojt_pcl_community_1_image)
                                                                        <img src="{{ $user_qualification->full_ojt_pcl_community_1_image }}"
                                                                            id="display_ojt_pcl_community_1_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src=""
                                                                            id="display_ojt_pcl_community_1_image"
                                                            ...
                                                            <input type="file" style="display:none"
                                                                id="drag-ojt_pcl_community_1_image" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    <div class="col-md-12 col-lg-12">
                                                        <label class="form-label">Clinical / Community Work Image 2
                                                            2*</label><br>
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                class="{{ $user_qualification && $user_qualification->ojt_pcl_community_2_image ? 'd-block' : 'd-none' }} img-delete-btn"
                                                                onclick="imageDelete('ojt_pcl_community_2_image')"
                                                                id="btn_ojt_pcl_community_2_image_delete"><i
                                                                    class="fa fa-times"></i></button>
                                                            <div class="drag-area drag-area-ojt_pcl_community_2_image">
                                                                <div
                                                                    class="dropify-message dropify-message-ojt_pcl_community_2_image {{ $user_qualification && $user_qualification->ojt_pcl_community_2_image ? 'd-none' : 'd-block' }}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        version="1.1" x="0px" y="0px" width="64px"
                                                                        height="64px" viewBox="0 0 64 64"
                                                                ...
                                                                <input name="ojt_pcl_community_2_image" type="hidden"
                                                                    id="ojt_pcl_community_2_image"
                                                                    value="{{ $user_qualification->ojt_pcl_community_2_image ?? old('ojt_pcl_community_2_image') }}"
                                                                    class="file-input" />
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->ojt_pcl_community_2_image)
                                                                        <img src="{{ $user_qualification->full_ojt_pcl_community_2_image }}"
                                                                            id="display_ojt_pcl_community_2_image"
                                                                            class="preview-image">
                                                                    @else
                                                                        <img src=""
                                                                            id="display_ojt_pcl_community_2_image"
                                                            ...
                                                            <input type="file" style="display:none"
                                                                id="drag-ojt_pcl_community_2_image" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-sm-12 mb-3">
                                                    <div class="col-md-12 col-lg-12">
                                                        <label class="form-label">Council Registration Certificate</label><br>
                                                        <div class="drag-container">
                                                            <button type="button"
                                                                class="{{ ($user_qualification && $user_qualification->council_registration_certificate) ? 'd-block' : 'd-none' }} img-delete-btn"
                                                                onclick="imageDelete('council_registration_certificate')"
                                                                id="btn_council_registration_certificate_delete"><i
                                                                    class="fa fa-times"></i></button>
                                                            <div class="drag-area drag-area-council_registration_certificate">
                                                                <div
                                                                    class="dropify-message dropify-message-council_registration_certificate {{ ($user_qualification && $user_qualification->council_registration_certificate) ? 'd-none' : 'd-block' }}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <input name="council_registration_certificate" type="hidden"
                                                                    id="council_registration_certificate"
                                                                    value="{{ $user_qualification->council_registration_certificate ??  old('council_registration_certificate') }}"
                                                                    class="file-input" />
                                                                <div class="image-preview"> @if($user_qualification &&
                                                                    $user_qualification->council_registration_certificate) <img
                                                                        src="{{ $user_qualification->full_council_registration_certificate }}"
                                                                        id="display_council_registration_certificate" class="preview-image"> @else <img
                                                                        src="" id="display_council_registration_certificate"
                                                                        class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <input type="file" style="display:none"
                                                                id="drag-council_registration_certificate" class="drag-image"
                                                                accept="image/*" />
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="drag-area drag-area-noc_image">
                                                                ...
                                                                <div class="image-preview">
                                                                    @if ($user_qualification && $user_qualification->noc_image)
                                                                        <img src="{{ $user_qualification->full_noc_image }}"
                                                                            id="display_noc_image" class="preview-image">
                                                                    @else
                                                                        <img src="" id="display_noc_image"
                                                                            class="d-none preview-image">
                                                                    @endif
                                                                </div>
                                                            </div>
        ...
        @section('footer-scripts')
            @include('officeadmin.applicant.js.pcl')
        @endsection
