            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('office_admin-district-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['districts']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
...
@include('officeadmin.district.js.list')
@endsection