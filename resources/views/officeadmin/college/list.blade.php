            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('office_admin-college-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                @foreach($result['colleges'] as $college)
                                <tr>
                                <tr>
                                    <td>{{$result['count']++}}</td>
                                    <td>{{ $college->name }}</td>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['colleges']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
...
@include('officeadmin.college.js.list')
@endsection