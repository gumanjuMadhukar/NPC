...
<div class="content">
    <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('office_admin-university-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if($result['universities']->count() > 0)
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                @foreach($result['universities'] as $university)
                                <tr>
                                <tr>
                                    <td>{{$result['count']++}}</td>
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input class="switch-input switch-status" type="checkbox"
                                                data-id="{{ $university->id }}" data-status-value="{{ $university->status }}"
                                                @if($university->
                                            status == 1) checked @endif /> <span class="switch-label" data-on="Show"
                                                data-off="Hide"></span> <span class="switch-handle"></span> </label>
                                    </td>
                                    <td>
                                        <a href="{{route('office_admin-university-addedit', ['id='.$university->id])}}"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['universities']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
...
@include('officeadmin.university.js.list')
@endsection