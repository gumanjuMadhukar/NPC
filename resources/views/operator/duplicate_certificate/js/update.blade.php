        ...
        $("#form").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                        window.location.href = "{{route('operator-certificate-profile', $certificate->id)}}";
                    }, 1000);
                },
                error: function(xhr) {
    ...
    $("#form2").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                toastr["success"](data.message);
                setTimeout(function() {
                        window.location.href = "{{route('operator-certificate-edit', $certificate->id)}}";
                    }, 1000);
            },
            error: function(xhr) {
                $('.btn-loading').prop('disabled', false);
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        'id': '{{ ($certificate->user) ? $certificate->user->id : 0 }}',
