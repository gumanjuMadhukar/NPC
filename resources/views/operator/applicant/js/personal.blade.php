...
<link href="{{ asset('assets/plugins/nepali-datepicker/nepali.datepicker.v4.0.4.min.css')}}" rel="stylesheet" type="text/css" />
<script>
        ...
        $("#form").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                        window.location.href = "{{route('operator-applicant-profile',$user->id)}}";
                    }, 1000);
                },
                error: function(xhr) {
