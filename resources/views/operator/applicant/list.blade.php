                ...
                <div class="card-body">
                    <form method="get" action="">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <select class="form-select select2" name="state_name">
                                    <option value="" @if($state_name=="") selected @endif>All States</option>
                                    @if($roles->count() > 0)
                                    @foreach($roles as $role)
                                    <option value="{{ $role->auth_name }}" @if($role->name == $state_name) selected @endif>{{ $role->name }}
                                    </option>
                                    @endforeach
                                    @endif
                                </select>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="btn-group mb-2">
                                        ...
                                        <a href="{{ route('operator-applicant-admitcard',$applicant->id) }}" class="btn btn-success p-0" title="View" data-bs-toggle="tooltip" data-bs-placement="top">Admit Card</i>
                                        </a>
                                        @endif
                                    </td>
                                </tr>
