            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="float-end"> <a href="{{route('operator-applicant-export', ['exam_id' => $exam_id, 'college_name' => $college_name, 'level_id' => $level_id, 'program_id' => $program_id, 'status' => $status])}}" class="btn btn-primary" type="submit"><i class="fas fa-file-excel"></i> Export Excel </a></div>
                            <div class="float-end"> <a href="javascript::void(0)" class="btn btn-success" id="forward_reexam" type="submit"><i class="fas fa-upload"></i> Forward Re-exam Files </a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                    <div class="">
                        <button class="btn btn-primary btn-xs float-end" id="move_selected_button">Move To Exam</button>
                    </div>
                    </div>
                    <h4 class="mt-0"><a href="" class="text-dark">Applicant List</a></h4>
                <!-- </div>
                <div class="card-body"> -->
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" class="selected_id" value="{{$applicant->id}}"> </td>
                                    <td>{{$result['count']++}}</td>
                                    ...
                                    <td class="btn-group mb-2">
                                        <a href="{{ route('operator-applicant-profile', $applicant->user->id) }}" class="btn text-primary" title="View" data-bs-toggle="tooltip" data-bs-placement="top">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button class="btn text-danger delete-applicant_apply" title="Delete" data-bs-toggle="tooltip" data-id="{{ $applicant->id }}"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
@include('operator.applicant.js.list')
@endsection