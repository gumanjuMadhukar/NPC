...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if($result['certificate_issuance_requests']->count() > 0)
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                @foreach($result['certificate_issuance_requests'] as $req_list)
                                <tr>
                                    <td>{{$result['count']++}}</td>
                                    ...
                                    <td>{{$req_list->payment?->transaction_id}}</td>
                                    <td>{{$req_list->amount}}</td>
                                    <td>{{$req_list->payment?->payment_method}}</td>
                                    <td>{{$req_list->payment?->payment_type}}</td>
                                    {{-- <td><span style="
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('operator-certificate-edit',$req_list->certificate->id) }}" class="btn text-warning" title="Edit" data-bs-toggle="tooltip" data-bs-placement="top">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        </div>
                                        <div class="btn-group">
                                            <a href="{{ route('operator-certificate-profile',$req_list->certificate->id) }}" class="btn text-success" title="Print Certificate" data-bs-toggle="tooltip" data-bs-placement="top">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['certificate_issuance_requests']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
