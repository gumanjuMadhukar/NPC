            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('operator-certificate-duplicate-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('operator-certificate-duplicate-addedit',['id='.$certificate->id]) }}" class="btn text-warning" title="Edit" data-bs-toggle="tooltip" data-bs-placement="top">
