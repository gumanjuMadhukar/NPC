                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$result['count']++}}</td>
                                    <td><img src="{{ $certificate->user?->info->getFullProfilePictureAttribute() }}" style="border-radius:50px; height: 45px; width:45px"></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @if ($certificate->user)    
                                                <a href="{{ route('operator-kyc-allocate_form', [$certificate->id, $certificate->user->name]) }}" class="btn text-warning" title="Allocate" data-bs-toggle="tooltip" data-bs-placement="top">
