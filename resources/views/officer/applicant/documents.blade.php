    ...
    <div class="card">
        <div class="card-body">
            <ul class="nav nav-tabs" id="documentTab" role="tablist">
                ...
                @if ($user->bachelor)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="bachelor-tab" data-bs-toggle="tab" data-bs-target="#bachelor" type="button" role="tab" aria-controls="bachelor" aria-selected="false">Bachelor
                            Documents</button>
                    </li>
                @endif
                @if ($user->master)
                                ...
                                <div class="row">
                                    ...
                                    @if ($user->tslc->migration_image)
                                        <div class="col-md-4 img-container">
                                            ...
                                            <div class="document-image"> <a
                                                    href="{{ $user->tslc->migration_image }}"
                                                    data-fancybox="image"><img
