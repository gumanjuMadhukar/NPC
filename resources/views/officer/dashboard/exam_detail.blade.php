                                ...
                                <div class="table-responsive">
                                    <table class="table mb-3 border">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('officer-dashboard-exam-statuswise-detail', ['status' => 'rejected', 'exam_id' => $exam_id]) }}"><i class="fas fa-eye"></i></strong></a></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('officer-dashboard-exam-statuswise-detail', ['status' => 're-exam', 'exam_id' => $exam_id]) }}"><i class="fas fa-eye"></i></strong></a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-3 border">
                                        <tr>
                                            <td><strong>1</strong></td>
                                            <td><strong>Officer Student</strong></td>
                                            <td><strong>{{ $officer_student_count }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td><strong>2</strong></td>
                                            <td><strong>Officer Accepted Student</strong></td>
                                            <td><strong>{{ $officer_accepted_count }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td><strong>3</strong></td>
                                            <td><strong>Officer Rejected Student</strong></td>
                                            <td><strong>{{ $officer_rejected_count }}</strong></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div>
                                ...
                                <div class="dropdown float-end">
                                    <a href="{{route('officer-applicant-programwise-export', ['exam_id' => $exam_id])}}" class="btn btn-primary" type="submit"><i class="fas fa-file-excel"></i> Export Excel </a>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-3 border">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('officer-dashboard-program-detail', ['program_id' => $program['program_id'], 'exam_id' => $exam_id]) }}"><i class="fas fa-eye"></i></strong></a></td>
                                        </tr>
                                        @php
                                        $sn++;
                                        @endphp
