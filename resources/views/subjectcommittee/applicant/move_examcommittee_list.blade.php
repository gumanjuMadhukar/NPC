...
$user_id = Auth::Guard('subject_committee')->id()
@endphp
<div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <!-- show move all button for given user only -->
                        @php 
                        if(in_array($user_id, array(5424))){
                            echo "<button></button>";
                        }
                        @endphp
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="float-end"> <a href="{{ route('subject_committee-move-examcommittee') }}" class="btn btn-primary" type="submit"><i class="fas fa-file-excel"></i> Move to Exam Committee </a></div>
                        </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('subject_committee-applicant-profile', $applicant->user->id) }}" class="btn text-primary" title="View" data-bs-toggle="tooltip" data-bs-placement="top">
