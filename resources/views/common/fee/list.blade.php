            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('operator-fee-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                        ...
                        <table class="table mb-0">
                            <thead>
                                <tr>
                                    <th width="50">SN.</th>
                                    <th>Name</th>
                                    <th width="150">Level ID</th>
                                    <th width="150">College Type</th>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['fees']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
