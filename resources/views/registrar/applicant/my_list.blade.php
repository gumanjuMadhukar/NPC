                ...
                <div class="card">
                    <div class="card-body">
                        @if ($result['applicants']->count() > 0)
                            <form id="move-to-subject-committee" method="POST"
                                action="{{ route('registrar-applicant-move-to-subject_committee') }}">
                                @csrf
                                <button type="submit" class="btn btn-warning"><strong>Move All to Subject
                                        Committee</strong></button>
                            </form>
