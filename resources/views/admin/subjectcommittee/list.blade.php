...
<div class="content">
    <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <a href="{{route('admin-subjectcommittee-addedit')}}" class="btn btn-primary float-end">
                                Add New
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if($result['subjectcommittees']->count() > 0)
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                @foreach($result['subjectcommittees'] as $subjectcommittee)
                                <tr>
                                <tr>
                                    <td>{{$result['count']++}}</td>
                                    <td>{{ $subjectcommittee->code }}</td>
                                    <td>{{ $subjectcommittee->name }}</td>
                                    <td>
                                        <label class="switch">
                                            <input class="switch-input switch-status" type="checkbox"
                                                data-id="{{ $subjectcommittee->id }}" data-status-value="{{ $subjectcommittee->status }}"
                                                @if($subjectcommittee->
                                            status == 1) checked @endif /> <span class="switch-label" data-on="Show"
                                                data-off="Hide"></span> <span class="switch-handle"></span> </label>
                                    </td>
                                    <td>
                                        <a href="{{route('admin-subjectcommittee-addedit', ['id='.$subjectcommittee->id])}}"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['subjectcommittees']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
...
@include('admin.subjectcommittee.js.list')
@endsection