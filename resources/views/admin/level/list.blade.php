            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">  <a href="{{route('admin-level-export')}}" class="btn btn-primary float-end">
                                Export
                            </a>
                            <a href="{{route('admin-level-addedit')}}" class="btn btn-primary float-end me-2">
                                Add New
                            </a>
                ...
                <div class="card-body">
                        ...
                        <table class="table mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Code</th>
                                    <th>Name</th>
                                    <th>Short Name In English</th>
                                    <th>Short Name In Nepali</th>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="float-end">
                                {{$result['levels']->links('pagination::bootstrap-4')}}
                            </div>
                        </div>
                    </div>
