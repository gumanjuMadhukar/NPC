...
<div class="content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="{{ route('examcommittee-applicant-save-bachelor') }}">
                            @csrf
                            ...
                            <div class="card">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        <label class="form-label">Universities</label>
                                        <select class="form-control select2" name="board_university"
                                            id="board_university">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 mb-3">
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        class="{{ ($user_qualification && $user_qualification->transcript_bac_4) ? 'd-block' : 'd-none' }} img-delete-btn"
                                                        onclick="imageDelete('transcript_bac_4')"
                                                        id="btn_transcript_bac_4_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-transcript_bac_4">
                                                        ...
                                                        <input name="transcript_bac_4" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->transcript_bac_4) <img
                                                                src="{{ $user_qualification->full_transcript_bac_4 }}"
                                                                id="display_transcript_bac_4" class="preview-image"> @else <img src=""
                                                                id="display_transcript_bac_4"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-transcript_bac_4"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-12 mb-3">
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        class="{{ ($user_qualification && $user_qualification->transcript_bac_5) ? 'd-block' : 'd-none' }} img-delete-btn"
                                                        onclick="imageDelete('transcript_bac_5')"
                                                        id="btn_transcript_bac_5_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-transcript_bac_5">
                                                        <div
                                                            class="dropify-message dropify-message-transcript_bac_5 {{ ($user_qualification && $user_qualification->transcript_bac_5) ? 'd-none' : 'd-block' }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                                x="0px" y="0px" width="64px" height="64px"
                                                                viewBox="0 0 64 64" enable-background="new 0 0 64 64"
                                                        ...
                                                        <input name="transcript_bac_5" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->transcript_bac_5) <img
                                                                src="{{ $user_qualification->full_transcript_bac_5 }}"
                                                                id="display_transcript_bac_5" class="preview-image"> @else <img src=""
                                                                id="display_transcript_bac_5"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-transcript_bac_5"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-12 mb-3">
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        class="{{ ($user_qualification && $user_qualification->transcript_bac_6) ? 'd-block' : 'd-none' }} img-delete-btn"
                                                        onclick="imageDelete('transcript_bac_6')"
                                                        id="btn_transcript_bac_6_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-transcript_bac_6">
                                                        <div
                                                            class="dropify-message dropify-message-transcript_bac_6 {{ ($user_qualification && $user_qualification->transcript_bac_6) ? 'd-none' : 'd-block' }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                                x="0px" y="0px" width="64px" height="64px"
                                                                viewBox="0 0 64 64" enable-background="new 0 0 64 64"
                                                        ...
                                                        <input name="transcript_bac_6" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->transcript_bac_6) <img
                                                                src="{{ $user_qualification->full_transcript_bac_6 }}"
                                                                id="display_transcript_bac_6" class="preview-image"> @else <img src=""
                                                                id="display_transcript_bac_6"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-transcript_bac_6"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        ...
                                                        id="btn_transcript_bac_7_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-transcript_bac_7">
                                                        <div
                                                            class="dropify-message dropify-message-transcript_bac_7 {{ ($user_qualification && $user_qualification->transcript_bac_7) ? 'd-none' : 'd-block' }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                                x="0px" y="0px" width="64px" height="64px"
                                                                viewBox="0 0 64 64" enable-background="new 0 0 64 64"
                                                        ...
                                                        <input name="transcript_bac_7" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->transcript_bac_7) <img
                                                                src="{{ $user_qualification->full_transcript_bac_7 }}"
                                                                id="display_transcript_bac_7" class="preview-image"> @else <img src=""
                                                                id="display_transcript_bac_7"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-transcript_bac_7"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        ...
                                                        id="btn_transcript_bac_8_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-transcript_bac_8">
                                                        <div
                                                            class="dropify-message dropify-message-transcript_bac_8 {{ ($user_qualification && $user_qualification->transcript_bac_8) ? 'd-none' : 'd-block' }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                                x="0px" y="0px" width="64px" height="64px"
                                                                viewBox="0 0 64 64" enable-background="new 0 0 64 64"
                                                        ...
                                                        <input name="transcript_bac_8" type="hidden"
                                                            id="transcript_bac_8"
                                                            value="{{ $user_qualification->transcript_bac_8 ??  old('transcript_bac_8') }}"
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->transcript_bac_8) <img
                                                                src="{{ $user_qualification->full_transcript_bac_8 }}"
                                                                id="display_transcript_bac_8" class="preview-image"> @else <img src=""
                                                                id="display_transcript_bac_8"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-transcript_bac_8"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        ...
                                                        onclick="imageDelete('noc_image')" id="btn_noc_image_delete"><i
                                                            class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-noc_image">
                                                        ...
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->noc_image) <img
                                                                ...
                                                                id="display_noc_image" class="preview-image"> @else <img src=""
                                                                id="display_noc_image" class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-noc_image"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    <button type="button"
                                                        ...
                                                        id="btn_visa_image_delete"><i class="fa fa-times"></i></button>
                                                    <div class="drag-area drag-area-visa_image">
                                                        ...
                                                        <input name="visa_image" type="hidden" id="visa_image"
                                                        ...
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->visa_image) <img
                                                                ...
                                                                id="display_visa_image" class="preview-image"> @else <img src=""
                                                                id="display_visa_image" class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-visa_image"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="drag-container">
                                                    ...
                                                    <div class="drag-area drag-area-passport_image">
                                                        ...
                                                        <input name="passport_image" type="hidden" id="passport_image"
                                                        ...
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->passport_image) <img
                                                                ...
                                                                id="display_passport_image" class="preview-image"> @else <img src=""
                                                                id="display_passport_image"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <input type="file" style="display:none" id="drag-passport_image"
                                                        class="drag-image" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
    ...
    @include('examcommittee.applicant.js.bachelor')
    @endsection
