                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $status =  'Rejeted';
                                    elseif ($exam_apply->state != 'operator')
                                    $status =  'Accepted';
                                    else
                                    $status = 'New Applied';
                                    @endphp
                                    ...
                                    ">
                                        ...
                                        <td>
                                            ...
                                            <p><button type="button" class="btn btn-primary" data-id="{{ $exam_apply->id }}"  data-bs-toggle="modal"  data-bs-target="#statusModal">Accept / Reject</button></p>
                                                    @endif -->
                                            <p><a href="{{ route('operator-applicant-apply-form', $exam_apply->id) }}"  class="btn btn-success">Edit</a></p>
                                            <p><button  class="btn btn-danger delete" data-id="{{ $exam_apply->id }}">Delete</button></p>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
