            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="{{ route('examcommittee-applicant-save-pcl') }}">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <select class="form-control select2" name="board_university" id="board_university">
                                                ...
                                                <option value="PCL" @if(old('board_university') == "PCL") selected @endif>PCL</option>
                                            </select>
<!-- 
                                            HSEB =>input
                                            PCL =>drop down -->
    ...
    @include('examcommittee.applicant.js.pcl')
    @endsection