...
<div class="content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="{{ route('examcommittee-applicant-save-tslc') }}">
                            @csrf
                            ...
                            <div class="card">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <input name="board_university" class="form-control"
                                            type="text" value="{{ $user_qualification->board_university ??  old('board_university') }}">
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3" id="nepal">
                                        <label class="form-label">College Name</label>
                                        <div id="college_name"> <select class="form-control select2" name="college_name">
                                            @if($colleges->count() > 0)
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        <label class="form-label">Board</label>
                                        <input name="board_university" class="form-control" id="board_university"
                                            type="text" value="CTEVT, Nepal" readonly>
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <input name="passed_year" class="form-control" collegetype="text"
                                            value="{{ $user_qualification->passed_year ??  old('passed_year') }}" mminlength="4" maxlength="4" />
                                    </div>
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-sm-12 mb-3">
                                                <div class="col-md-12 col-lg-12">
                                                    <label class="form-label">OJT Image *</label><br>
                                                    <div class="drag-container">
                                                        <button type="button"
                                                            class="{{ ($user_qualification && $user_qualification->ojt_image) ? 'd-block' : 'd-none' }} img-delete-btn"
                                                            onclick="imageDelete('ojt_image')"
                                                            id="btn_ojt_image_delete"><i
                                                                class="fa fa-times"></i></button>
                                                        <div class="drag-area drag-area-ojt_image">
                                                            <div
                                                                class="dropify-message dropify-message-ojt_image {{ ($user_qualification && $user_qualification->ojt_image) ? 'd-none' : 'd-block' }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                    version="1.1" x="0px" y="0px" width="64px"
                                                                    height="64px" viewBox="0 0 64 64"
                                                            ...
                                                            <input name="ojt_image" type="hidden" id="ojt_image"
                                                                value="{{ $user_qualification->ojt_image ??  old('ojt_image') }}"
                                                                class="file-input" />
                                                            <div class="image-preview"> @if($user_qualification &&
                                                                $user_qualification->ojt_image) <img
                                                                    src="{{ $user_qualification->full_ojt_image }}"
                                                                    id="display_ojt_image" class="preview-image"> @else <img src=""
                                                                    id="display_ojt_image" class="d-none preview-image">
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <input type="file" style="display:none" id="drag-ojt_image"
    ...
    @include('examcommittee.applicant.js.tslc')
    @endsection
