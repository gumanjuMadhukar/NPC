...
<div class="content">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="frm_profile" method="post" action="{{ route('council-account-store') }}">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="frm_password" method="post" action="{{ route('council-account-update-password') }}">
                            @csrf
                            <div class="mb-3">
    ...
    @include('council.account.js.index')
    @endsection