        ...
        <div class="card">
            <div class="card-body container">
                <h4 class="text-danger">
                    Note: Before applying for the liscence please review your profile 
        ...
        <div class="card">
            <div class="card-body conatiner">
                <span class="text-justify">
                    ...
                    <div class="row mt-3">
                        <form method="post" id="form" action="{{route('student-foreign-certificate-apply')}}">
                            @csrf
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="drag-container">
                                            ...
                                            <div class="drag-area drag-area-voucher_image">
                                                ...
                                                <div class="image-preview"> @if($user &&
                                                    $user->info?->voucher_image)
