                            ...
                            <form id="form" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        ...
                                        <input class="form-control myInput" name="country"
                                            value="{{ $user->info->country ?? old('country') }}" type="text">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        <label class="form-label">State / Province / Region *</label>
                                        <input class="form-control myInput" name="state_province_region"
                                            value="{{ $user->info->state_province_region ?? old('state_province_region') }}"
                                            type="text">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        <label class="form-label">State / Province / Region *</label>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        ...
                                        <input class="form-control myInput" name="city_town"
                                            value="{{ $user->info->city_town ?? old('city_town') }}" type="text">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        <label class="form-label">Street Name / Adddressline *</label>
                                        <input class="form-control myInput" name="street_name"
                                            value="{{ $user->info->street_name ?? old('street_name') }}" type="text">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-3">
                                        <label class="form-label">Postal / Zip Code *</label>
                                        <input class="form-control myInput" name="postal_zip_code"
                                            value="{{ $user->info->postal_zip_code ?? old('postal_zip_code') }}"
                                            type="text">
                                    </div>
                                </div>
