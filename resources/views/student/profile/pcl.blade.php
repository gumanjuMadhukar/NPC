            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="{{ route('student-profile-save-pcl') }}">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <select class="form-control select2" name="board_university" id="board_university">
                                                <option value="HSEB" @if(old('board_university') == "HSEB") selected @endif>HSEB</option>
                                                <option value="CTEVT, NEPAL" @if(old('board_university') == "CTEVT, NEPAL") selected @endif>CTEVT, NEPAL</option>
                                            </select>
<!--
                                            HSEB =>input
                                            PCL =>drop down -->
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="drag-container">
                                                    ...
                                                    <div class="drag-area drag-area-ojt_pcl_community_1_image">
                                                        ...
                                                        <input name="ojt_pcl_community_1_image" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->ojt_pcl_community_1_image) <img
                                                                src="{{ $user_qualification->full_ojt_pcl_community_1_image }}"
                                                                id="display_ojt_pcl_community_1_image" class="preview-image"> @else <img
                                                                src="" id="display_ojt_pcl_community_1_image"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12 mb-3">
                                            <div class="col-md-12 col-lg-12">
                                                <label class="form-label">Clinical / Community Work Image 2*</label><br>
                                                <div class="drag-container">
                                                    <button type="button"
                                                    ...
                                                    <div class="drag-area drag-area-ojt_pcl_community_2_image">
                                                        ...
                                                        <input name="ojt_pcl_community_2_image" type="hidden"
                                                            ...
                                                            class="file-input" />
                                                        <div class="image-preview"> @if($user_qualification &&
                                                            $user_qualification->ojt_pcl_community_2_image) <img
                                                                src="{{ $user_qualification->full_ojt_pcl_community_2_image }}"
                                                                id="display_ojt_pcl_community_2_image" class="preview-image"> @else <img
                                                                src="" id="display_ojt_pcl_community_2_image"
                                                                class="d-none preview-image">
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12 mb-3">
                                            <div class="col-md-12 col-lg-12">
                                                <label class="form-label">NOC / Others</label><br>
                                                <div class="drag-container">
                                                    <button type="button"
                            ...
                            <div class="mb-3">
                                <a href="{{ route('student-profile-slc')}}" class="btn btn-primary"> Back</a>
    ...
    @include('student.profile.js.pcl')
    @endsection
