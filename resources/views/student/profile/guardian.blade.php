                        ...
                        <form id="form" method="post" action="{{ route('student-profile-save-guardian') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input class="form-control" name="father_name_nep" value="{{ $user->father_name_nep ??  old('father_name_nep') }}" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input class="form-control" name="mother_name_nep" value="{{ $user->mother_name_nep ??  old('mother_name_nep') }}" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12  mb-3">
                                    ...
                                    <input class="form-control" name="grandfather_name_nep" value="{{ $user->grandfather_name_nep ??  old('grandfather_name_nep') }}" type="text">
                                </div>
                            </div>
                            <div class="mb-3">
