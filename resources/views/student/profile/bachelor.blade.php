...
<div class="content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="{{ route('student-profile-save-bachelor') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                <a href="{{ route('student-profile-pcl')}}" class="btn btn-primary"> Back</a>
    ...
    @include('student.profile.js.bachelor')
    @endsection
